  ...
  */
  List<Widget> getTitles(BuildContext context) {
    return [
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_title_1", context),
      ...
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_title_2", context),
          style: GoogleFonts.quicksand(
            color: Colors.white,
            fontSize: 24.sp,
            fontWeight: FontWeight.bold,
      ...
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_title_3", context),
          style: GoogleFonts.quicksand(
            color: Colors.white,
            fontSize: 24.sp,
            fontWeight: FontWeight.bold,
  ...
  List<Widget> getSubtitles(BuildContext context) {
    return [
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_subtitle_1", context),
          style: GoogleFonts.quicksand(
            color: Colors.white,
            fontSize: 14.sp,
      ...
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_subtitle_2", context),
          style: GoogleFonts.quicksand(
            color: Colors.white,
            fontSize: 14.sp,
            fontWeight: FontWeight.w400,
      ...
      SmoothSlide(
        child: Text(
          Translate.translate("onboard_subtitle_3", context),
          style: GoogleFonts.quicksand(
            color: Colors.white,
            fontSize: 14.sp,
            fontWeight: FontWeight.w400,
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      AnimatedSmoothIndicator(
                        effect: ExpandingDotsEffect(
                          ...
                          activeDotColor: Color(0xffAB10E2),
                        ),
                        activeIndex: index,
                        count: 3,
                      ),
                  ...
                  MyGradientButton(
                    ...
                    child: Center(
                      child: Text(
                        Translate.translate("onboard_cta", context),
                        style: GoogleFonts.quicksand(
                          color: Colors.white,
