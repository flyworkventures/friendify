...
class LoginViewState extends ConsumerState<LoginView> {
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Text(
                Translate.translate("login_get_started_title", context),
              ...
              Text(
                Translate.translate("login_get_started_subtitle", context),
                style: GoogleFonts.quicksand(
                  color: Colors.white,
                  fontSize: 16.sp,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10.w),
                        Text(
                          Translate.translate("login_provider_apple", context),
                          style: GoogleFonts.quicksand(
                            color: Colors.white,
                            fontSize: 16.sp,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          Translate.translate("login_provider_google", context),
                          style: GoogleFonts.quicksand(
                            color: Colors.black,
                            fontSize: 16.sp,
                            fontWeight: FontWeight.w600,
                  ...
                  child: Center(
                    child: Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10.h),
                        Text(
                          Translate.translate("continue_with_google", context),
                          style: GoogleFonts.quicksand(
                            color: Colors.black,
                            fontSize: 14.sp,
                            fontWeight: FontWeight.w500,
              ...
              GestureDetector(
                onTap: () async {
                  await launchUrl(
                    Uri.parse("https://fly-work.com/friendify/terms/"),
                  );
                },
  ...
  Future login() async {
    ...
    if (res.statusCode == 200) {
      ...
      Navigator.push(
        context,
        CupertinoPageRoute(builder: (context) => AgentsScreen()),
      );
  ...
  Widget signUpWithWidget() {
    return Row(
      ...
      children: [
        ...
        Text(
          Translate.translate("or", context),
          style: GoogleFonts.poppins(
            color: Color(0xffB1B1B1),
            fontWeight: FontWeight.w400,
            fontSize: 12.sp,
    ...
    return Row(
      children: [
        Checkbox(
          value: false,
          onChanged: (a) {},
          side: BorderSide(color: Colors.grey.withValues(alpha: 0.7), width: 1),
        ...
        Text(
          Translate.translate("remember_me", context),
          style: GoogleFonts.poppins(
  ...
  Widget socialAuthAreaIOS() {
    return Row(
      ...
      children: [
        socialButton(
          onTap: () {},
          child: Center(child: Image.asset("assets/google.png", width: 20.w)),
          backgroundColor: Colors.white,
        ),
        SizedBox(width: 15.w),
        /*
