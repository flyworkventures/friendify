          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                 Text(agent.name,style: GoogleFonts.quicksand(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 14.sp),),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(colors: [Color(0xffAB10E2),Color(0xff2D30FF)])
                  ),
                  child: Center(
                    child: SvgPicture.asset("assets/icons/send-magic.svg",width: 13.w,),
                  ),
                )
              ],),
            ),
